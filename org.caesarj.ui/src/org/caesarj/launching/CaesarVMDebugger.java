...
import org.caesarj.debug.model.CaesarDebugTarget;
...
public class CaesarVMDebugger extends StandardVMDebugger {
	/**
	...
	public CaesarVMDebugger(IVMInstall vmInstance) {
		super(vmInstance);
	}
				...
				do  {
					try {
						...
						if (vm != null) {
							...
							CaesarDebugTarget.newDebugTarget(launch, vm, renderDebugTarget(config.getClassToLaunch(), port), process, true, false, config.isResumeOnStartup());
							subMonitor.worked(1);
							subMonitor.done();
						}
						return;
