...
public class CaesarPluginImages {
	...
	*/
	...
	public static final String IMG_INTERFACE_DC_COLLABOR = NAME_PREFIX + "collab_co.gif";
	...
	public static final ImageDescriptor DESC_COLLAB_CO = createManaged(IMG_INTERFACE_DC_COLLABOR);
