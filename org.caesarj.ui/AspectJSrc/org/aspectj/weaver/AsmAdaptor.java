...
//			enclosingNode.getSourceLocation(),
	...
	{
        if(classNode!=null)
            System.out.println("~~~ searching in class "+classNode.getName());
        else
            System.out.println("~~~ searching class is null");
        System.out.println("~~~ for "+member.getName()+" with signature "+member.getSignature());
